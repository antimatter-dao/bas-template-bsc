...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			params.TestUsageMainnetChainConfig,
			params.TestUsageMainnetGenesisHash,
			[]testcase{
...
func TestValidation(t *testing.T) {
	...
	for i, tt := range tests {
		filter := newFilter(params.TestUsageMainnetChainConfig, params.TestUsageMainnetGenesisHash, func() uint64 { return tt.head })
