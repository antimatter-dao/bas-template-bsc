...
var (
	TestUsageMainnetGenesisHash = common.HexToHash("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3")
...
var TrustedCheckpoints = map[common.Hash]*TrustedCheckpoint{
	TestUsageMainnetGenesisHash: TestUsageMainnetTrustedCheckpoint,
...
var CheckpointOracles = map[common.Hash]*CheckpointOracleConfig{
	TestUsageMainnetGenesisHash: TestUsageMainnetCheckpointOracle,
...
var (
	// TestUsageMainnetChainConfig is the chain parameters to run a node on the main network.
	TestUsageMainnetChainConfig = &ChainConfig{
	...
	// TestUsageMainnetTrustedCheckpoint contains the light client trusted checkpoint for the main network.
	TestUsageMainnetTrustedCheckpoint = &TrustedCheckpoint{
		SectionIndex: 371,
	...
	// TestUsageMainnetCheckpointOracle contains a set of configs for the main network oracle.
	TestUsageMainnetCheckpointOracle = &CheckpointOracleConfig{
	...
	// TestUsageChainConfig is the chain parameters to run a node on the test usage mainnet network.
	TestUsageChainConfig = &ChainConfig{
		ChainID:             big.NewInt(1),
		HomesteadBlock:      big.NewInt(1_150_000),
		EIP150Block:         big.NewInt(2_463_000),
		EIP150Hash:          common.HexToHash("0x2086799aeebeae135c246c65021c82b4e15a2c451340993aacfd2751886514f0"),
	...
	TestChainConfig = &ChainConfig{
		...
		BrunoBlock:          big.NewInt(0),
		BlockRewardsBlock:   nil,
		Ethash:              new(EthashConfig), // use pow for fitting eth tests
		Clique:              nil,
		Parlia:              nil,
	}
)
